 ...
 * dbo.PortalUsers (SapUsername / SapPasswordEncrypted — see
 ...
 * (Node/"normanton-nexus") already has a working, reliable SQL connection to
...
import { sapCredEncryptionKey, getNexusPool } from '../config.js';
