  ...
  switch (targetType) {
    case 'user':
      userQuery = `
        ...
        WHERE Username = @val AND Status = N'approved'`;
      break;
    ...
    case 'department':
      userQuery = `
        ...
        WHERE  ud.Department = @val AND pu.Status = N'approved'`;
      break;
    ...
    case 'permission':
      userQuery = `
        ...
        WHERE  up.PermissionCode = @val AND pu.Status = N'approved'`;
      break;

    case 'role':
      userQuery = `
        SELECT UserID FROM dbo.PortalUsers
        WHERE Role = @val AND Status = N'approved'`;
      break;
