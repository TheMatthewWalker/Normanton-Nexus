...
- **Scheduled jobs (`node-cron`)**, all defined in `server.js`, deliberately staggered to avoid clashing:
  ...
  | `30 4 * * 0` | `runMrpHistoryRefresh()` | MRP Analysis year-on-year consumption/goods-receipt history, weekly (Sunday) |
